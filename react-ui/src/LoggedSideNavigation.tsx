...
const LoggedSideNavigation: React.FC = () => {
    ...
    return (<div className="min-h-screen flex flex-col flex-auto flex-shrink-0 antialiased bg-gray-50 text-gray-800">
                    ...
                    <ul className="flex flex-col py-6 space-y-1">
                        ...
                        <li className="px-5">
                            <div className="flex flex-row items-center h-8">
                                <div className="flex font-semibold text-sm text-gray-300 my-4 font-sans uppercase">Configurações</div>
                            </div>
                        </li>
                        <li>
                            <GoogleLogout clientId={clientId} onLogoutSuccess={successGoogleLogoutResponse} render={renderProps => (
                                <button onClick={renderProps.onClick} className="w-full w-auto relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-700 text-gray-500 hover:text-gray-200 border-l-4 border-transparent hover:border-red-500 pr-6">
                                <span className="inline-flex justify-center items-center ml-4 text-red-400">
                                    ...
                                    <span className="ml-2 font-semibold text-sm tracking-wide truncate font-sans">Sair</span>
                                </button>
                            )} />
                        </li>
                    </ul>
